        ...
        <div class="container-fluid px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- <form class="d-flex" action="index.php" method="get">      
                    <input class="form-control me-2" type="text" placeholder="index" aria-label="index" name="keywords" autocomplete="off"> -->
                    <button class="btn btn-outline-dark" type="submit" value="index">index</button> 
                </form>
